...
CARD_NO_ONE_HAS_VOTED_ON = Card.create(body: 'no one has voted on this one', conversation: CONVO1)

UPVOTE = 1 #Attitude.create(score: 1)
DOWNVOTE = -1 #Attitude.create(score: -1)
